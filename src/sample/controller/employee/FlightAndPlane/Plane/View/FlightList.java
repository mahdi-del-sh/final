...
public class FlightList {
    ...
    void initialize() throws SQLException, ClassNotFoundException {
        ...
        Ticket.setOnAction(event -> {
            ...
            loader.setLocation(getClass().getResource("/sample/view/employee/FlightAndPlane/Plane/View/Ticket.fxml"));
            try{
                loader.load();
            }catch (IOException e){
                e.printStackTrace();
...
//loginMenuController.ChangeWindow(Ticket , "/sample/view/manager/FlightAndPlane/Plane/View/Ticket.fxml" , "Ticket management");
        ...
        HomeBTN.setOnAction(event -> {
            loginMenuController.ChangeWindow(HomeBTN , "/sample/view/employee/FlightAndPlane/Plane/View/View.fxml" , "Flight Management");
        });
