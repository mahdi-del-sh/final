                ...
                if(CheckRegex()){
                    ...
                    try {
                        if(databaseHandler.CheckUsername(UsernameTXF.getText())){
                            ...
                            databaseHandler.addManager(FirstNameTXF.getText() , LastnameTXF.getText() , UsernameTXF.getText() , PasswordTXF.getText() , PhoneTXF.getText() , AddressTXF.getText() , EmailTXF.getText() , Double.valueOf(SalaryTXF.getText()) );
                        }
                        else{
